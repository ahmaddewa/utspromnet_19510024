											...
											<li>
												<div class="timeline-panel">
													...
													<div class="media-body">
														<h4 class="mb-1">Ahmad Dewa Fitrah</h4>
                                                        <h6 class="mb-1">Fitur :</h6>
														<small class="d-block">- Realtime Grafik (Chart) sesuai Database</small>
                                                        <small class="d-block">- Anti SQL Injection</small>
                                                        <small class="d-block">- Status On/Of</small>
                                                        <small class="d-block">- Pagination</small>
                                                        <small class="d-block">- Tambah Mahasiswa</small>
                                                        <small class="d-block">- Edit Mahasiswa</small>
                                                        <small class="d-block">- Hapus Mahasiswa</small>
                                                        <small class="d-block">- Tampilan Mahasiswa</small>
                                                        <small class="d-block">- Tambah Admin</small>
                                                        <small class="d-block">- Tampilan Admin</small>
                                                        <h6 class="mb-1">Next Update :</h6>
                                                        <small class="d-block">- Daftar (Register) Akun</small>
                                                        <small class="d-block">- Login</small>
                                                        <small class="d-block">- Dll</small>
													</div>
												</div>
											</li>
											<li>
												<div class="timeline-panel">
													...
													<div class="media-body">
														<h4 class="mb-1">Muhammad Ashraf</h4>
														<small class="d-block">- Template Mota Admin</small>
													</div>
												</div>
											</li>
